...
public class Home extends AppCompatActivity {
    ...
    String pWord="";
    int numm=0;
    Home.Connect sendMessageTask;
    //String IP = "10.12.18.8";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cleaner = (Button)findViewById(R.id.button15);
        sendMessageTask = new Home.Connect();
        ...
        cleaner.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent Clean = new Intent(Home.this, CleanerLogin.class);
                startActivity(Clean);
                finish();
            }
        });
    ...
    private class Connect extends Thread {
        ...
        public void run() {
            ...
            try {
                /**
                 * Ip To Change in roomConfirm,guestHome,CleanerLogin,CleanerHome
                 */
                ...
                while(running){
                    ...
                    if(clientCommand.startsWith("NotificationTrue 431") && noti == true && num.equals("431")
                        ...
                        runOnUiThread(new Runnable() {
                            public void run() {
                                //Toast.makeText(Home.this,"NotificationTrue", Toast.LENGTH_SHORT).show();
                    ...
                    }else if(clientCommand.equals("Cleaning 431")&& noti == true && num.equals("431")
                            || clientCommand.equals("Cleaning 436") && noti == true && num.equals("436")
                            || clientCommand.equals("Cleaning 593") && noti == true && num.equals("593")){
                        runOnUiThread(new Runnable() {
                            public void run() {
                                //Toast.makeText(Home.this,"Cleaning", Toast.LENGTH_SHORT).show();
                                String[] str = clientCommand.split("\\s+");
                                String Room =""+str[1];
                                notificationCleaning(Room);
                            }
                        });
                    }
                    ////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void notificationCleaning(String room){
        Intent intent = new Intent(this, NotificationClean.class);
        //Bundle bundle = new Bundle();
        //bundle.putString("clean",room);
        //intent.putExtras(bundle);
        //intent.putExtra("clean",room);
        //intent.putExtra("notificationID", NOTIFICATION_ID);
        PendingIntent pIntent = PendingIntent.getActivity(this, 0, intent, 0);

        Notification.Builder baseNotification = new Notification.Builder(Home.this)
                .setContentTitle("Cleaning Service")
                .setContentText("Room: "+room+" is being Cleaned")
                .setTicker("Cleaning Service")
                .setSmallIcon(R.drawable.icon0)
                .setLights(0xffcc00, 1000, 500)
                .setContentIntent(pIntent);
